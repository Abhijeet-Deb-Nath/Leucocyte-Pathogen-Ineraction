...
RL_CONTEXTUAL_SIGNAL_BONUS = 0.55
RL_EFFECTIVE_SIGNAL_BONUS = 0.55
RL_SIGNAL_PROGRESS_BONUS = 0.12
RL_INEFFECTIVE_SIGNAL_PENALTY = 0.2
RL_REDUNDANT_SIGNAL_PENALTY = 0.5
